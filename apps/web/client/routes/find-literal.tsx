  ...
  return (
    <section>
      ...
      <p className="subtitle">
        Exhaustive substring search across indexed chunk text. Use for audits where every occurrence
        matters: stale file-path references, deprecated config keys, dead deprecation-marker
        strings. Distinct from <code>search</code> (ranked retrieval) and <code>find-usages</code>{" "}
        (exact code symbol). For total file coverage on safety-critical audits, supplement with{" "}
        <code>rg</code>.
      </p>
