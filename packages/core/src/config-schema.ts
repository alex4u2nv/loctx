...
export const CONFIG_SCHEMA: ReadonlyArray<SectionSchema> = Object.freeze([
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "analyzers.duplicates.semantic",
        yamlPath: ["analyzers", "duplicates", "semantic"],
        label: "semantic",
        help: "Include embedding-based near-duplicate groups in find_duplicates. Query-time only; reads vectors the index already stores.",
        type: "bool",
        default: false,
      },
      {
        key: "analyzers.duplicates.semanticThreshold",
        yamlPath: ["analyzers", "duplicates", "semantic_threshold"],
        label: "semantic_threshold",
        help: "Cosine-similarity floor for a semantic pair, as a percent (92 = 0.92).",
        type: "int",
        default: 92,
        min: 50,
        max: 100,
      ...
      {
        key: "analyzers.duplicates.semanticMaxChunks",
        yamlPath: ["analyzers", "duplicates", "semantic_max_chunks"],
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "analyzers.quality.markdownRules",
        yamlPath: ["analyzers", "quality", "markdown_rules"],
        label: "markdown_rules",
        help: "Markdown context rules: flag stale path references and docs that drifted from the code they cite.",
        type: "bool",
        default: true,
      },
      {
        key: "analyzers.quality.docDriftFloor",
        yamlPath: ["analyzers", "quality", "doc_drift_floor"],
        label: "doc_drift_floor",
        help: "doc-drift fires when doc/code similarity falls below this percent (35 = 0.35).",
        type: "int",
        default: 35,
        min: 5,
        max: 95,
